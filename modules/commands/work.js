...
//random coins nhận được khi làm việc ít nhất 100
var coinscn = Math.floor(Math.random() * 301) + 100; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 601) + 100; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 201) + 100; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 401) + 100; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 201) + 100; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 201) + 100; //random coins khi đào đá
    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(event.body) {
                ...
                case "7": msg = "Bạn có thể xin admin vài đồng nếu muốn có thể dùng callad"; break; //thêm case nếu muốn 
                default: break;
            };
