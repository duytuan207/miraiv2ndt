...
msg.push(`${i++}: ${name}\nhttps://facebook.com/${idAdmin}`);
  ...
  var hi = ["Admin bot rất đẹp trai","Admin đang kiếm người yêu","Bạn sẽ bị ban nếu spam bot","Tuấn rất đẹp chai","Tuấn có bán follow","Tuấn múa fo lon ti nô rất hay","SOS","Bủh bủh lmao","Đây là mirai 1.5 do Tuấn đẹp zai mod lại","Tuấn chỉ biết copy và dán","Nhìn nịt, có gì đâu mà nhìn, nhìn gái kìa"];
