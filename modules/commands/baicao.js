  ...
  var money = data.money     
    ...
    case 'check': {
      for (const key in values.player) {
		...
		default: {
			console.log("[ Nguyễn Duy Tuấn ] » Bài cào thuộc sở hữu của Nguyễn Duy Tuấn!")
		}
	}
}
...
module.exports.onLoad = async () => {
  ...
  console.log("[ INFO: Bai Cao Load ] » ");
  console.log("[ Bot Nguyen Duy Tuan ] » Đã Active Thành Công - Bot Nguyễn Duy Tuấn!");
